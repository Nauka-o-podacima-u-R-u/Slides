...
-	***Upoznavanje sa oblasti "Nauka o podacima"***

-	***Upoznavanje sa R programskim jezikom***

-	***Ovladavanje savremenim metodama naučne analize podataka***
...
# local
knitr::include_graphics("Figures/Nauka_google.jpg")
```
...
# Nauka o podacima (Data Science) `r emo::ji("face")`
...
-	***Ima za cilj ekstrakciju znanja iz podataka***
...
- ***U srodstvu sa Earth Observation***
