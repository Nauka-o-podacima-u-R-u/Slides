...
dat1 <- readxl::read_excel(path = here::here("data", "covid.xlsx")) %>%
  as.data.frame()

dat2 <- readxl::read_excel(path = here::here("data", "covid_2.xlsx")) %>%
  as.data.frame() %>%
...
opstine <- sf::st_read(here::here("data", "gadm36_SRB_2.shp"))
sf_opstine <- sf::st_as_sf(opstine)
